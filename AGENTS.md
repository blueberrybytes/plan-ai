...
This project is indexed by GitNexus as **plan** (7005 symbols, 17129 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
