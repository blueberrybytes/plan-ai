...
This project is indexed by GitNexus as **plan-recorder** (696 symbols, 1629 relationships, 58 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
