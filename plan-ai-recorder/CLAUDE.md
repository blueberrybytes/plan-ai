...
This project is indexed by GitNexus as **plan-recorder** (613 symbols, 1326 relationships, 51 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
