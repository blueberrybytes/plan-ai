...
This project is indexed by GitNexus as **plan-mobile** (585 symbols, 1271 relationships, 47 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
