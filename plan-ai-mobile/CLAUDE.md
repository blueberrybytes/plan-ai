...
This project is indexed by GitNexus as **plan-mobile** (542 symbols, 1099 relationships, 43 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
