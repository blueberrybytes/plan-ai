          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            {mode === "blank" && (
              <Typography variant="body1" color="text.secondary">
                You can specify a title above, or skip it. In the next step, select transcripts or
                contexts to include. We will generate the document based on your selected sources.
              </Typography>
            )}
          </Box>
        )}
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", mt: 5 }}>
          ...
          {activeStep < STEPS.length - 1 ? (
            <Button
              ...
              disabled={
                activeStep === 0 &&
                ((mode === "prompt" && !prompt.trim()) || (mode === "import" && !file))
              }
            ...
            <Button
              ...
              disabled={(mode === "prompt" && !prompt.trim()) || (mode === "import" && !file)}
            >
