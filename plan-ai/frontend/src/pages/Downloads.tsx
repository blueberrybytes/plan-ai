            ...
            >
              <CardContent sx={{ flexGrow: 1, p: 4 }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  ...
                  {/* iOS */}
                  <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", p: 2, borderRadius: 2, bgcolor: "background.default", opacity: 0.7 }}>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                      <AppleIcon />
                      <Typography sx={{ fontWeight: 600 }}>iOS (iPhone/iPad)</Typography>
                    </Box>
                    <Chip size="small" label="Coming Soon" color="default" sx={{ fontWeight: 600 }} />
                  </Box>
                </Box>
              </CardContent>
            </Card>
