      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        <Box sx={{ mb: 6, textAlign: "center" }}>
          ...
          <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 600, mx: "auto" }}>
            Experience the full power of Plan AI. Record system audio natively on your desktop, or
            capture in-person meetings on the go with our mobile app.
          </Typography>
        </Box>
            ...
            >
              <CardContent sx={{ flexGrow: 1, p: 4 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                  Native desktop application to seamlessly capture system audio and your microphone
                  during Zoom, Google Meet, and Microsoft Teams calls.
                </Typography>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent sx={{ flexGrow: 1, p: 4 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                  The perfect companion for in-person meetings. Record live conversations,
                  whiteboarding sessions, and automatically sync transcripts back to your web
                  dashboard.
                </Typography>
