  ...
  const defaultSuggestions: ChatSuggestion[] = focusedProject
    ? [
        ...
        },
        {
          ...
          prompt:
            "List the open action items extracted from this project's recent meetings.",
        },
        {
        ...
        },
        {
          ...
          prompt: "What are the main themes and pain points across this project's meetings this month?",
        },
      ]
    : [
        {
        ...
        },
        {
          ...
          prompt: "Give me meeting stats for this month: count, total hours, and sentiment breakdown.",
        },
        {
    ...
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%", position: "relative" }}>
      ...
      >
        ...
        {messages.length === 0 ? (
          showWelcome ? (
            <ChatEmptyState
              title={focusedProject ? `Ask me about ${focusedProject.title}` : "How can I help you today?"}
              subtitle={
                focusedProject
      ...
      {attachments.error && (
        <Box sx={{ px: 3, pb: 1 }}>
          <Alert severity="error" onClose={() => attachments.setError(null)} sx={{ fontSize: "0.85rem" }}>
            {attachments.error}
          </Alert>
        </Box>
      )}
      ...
      <ChatInput
        ...
        placeholder={
          focusedProject
            ? `Ask anything about ${focusedProject.title}...`
            : "Ask me anything..."
        }
        topSlot={
