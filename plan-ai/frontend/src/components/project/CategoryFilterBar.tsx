...
export type TaskCategoryFilter = "all" | "engineering" | "design" | "support" | "ops" | "research";
...
const CategoryFilterBar: React.FC<CategoryFilterBarProps> = ({ value, onChange, counts }) => {
  ...
  const OPTIONS: Array<{
    ...
    {
      key: "all",
      labelKey: "projectDetails.categoryFilter.all",
    ...
    {
      key: "ops",
      labelKey: "projectDetails.categoryFilter.ops",
