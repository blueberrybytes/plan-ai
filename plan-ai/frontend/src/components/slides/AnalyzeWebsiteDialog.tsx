        ...
        {!result ? (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            <Typography variant="body2" color="text.secondary">
              Enter the URL of your company&apos;s website. Our AI will analyze the styles, fonts,
              and images to generate a brand theme automatically.
            </Typography>
            <TextField
              fullWidth
              label="Website URL"
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              <Box>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <Box
                    sx={{ width: 24, height: 24, borderRadius: 1, bgcolor: result.primaryColor }}
                  />
              ...
              <Box>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <Box
                    sx={{ width: 24, height: 24, borderRadius: 1, bgcolor: result.secondaryColor }}
                  />
