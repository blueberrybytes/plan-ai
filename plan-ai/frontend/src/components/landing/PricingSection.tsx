...
const TIERS: PricingTier[] = [
  {
    key: "proByok",
    track: "byok",
    href: "https://buy.stripe.com/REPLACE_PRO_BYOK",
    ctaKey: "ctaBuy",
  },
  {
    key: "proManaged",
    track: "managed",
    href: "https://buy.stripe.com/REPLACE_PRO_MANAGED",
    ctaKey: "ctaBuy",
    highlight: true,
  },
  {
    key: "businessByok",
    track: "byok",
    href: "https://buy.stripe.com/REPLACE_BUSINESS_BYOK",
    ctaKey: "ctaBuy",
  },
  {
    key: "businessManaged",
    track: "managed",
    href: "https://buy.stripe.com/REPLACE_BUSINESS_MANAGED",
    ctaKey: "ctaBuy",
  },
  {
    key: "enterprise",
    track: "both",
    href: "mailto:hello@blueberrybytes.com?subject=Plan%20AI%20Enterprise",
    ctaKey: "ctaContact",
  },
];
    ...
    return (
      <Box
        sx={{
          ...
          bgcolor: tier.highlight ? alpha(theme.palette.primary.main, 0.04) : "background.paper",
