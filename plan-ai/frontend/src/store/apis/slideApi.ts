...
export type PublicPresentationResponse = components["schemas"]["PublicPresentationResponse"];
export type GeneratePresentationRequest = components["schemas"]["GeneratePresentationRequest"];
export type UpdatePresentationRequest = components["schemas"]["UpdatePresentationRequest"];
export type GenerateSingleSlideRequest = components["schemas"]["GenerateSingleSlideRequest"];
...
export const slideApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getPublicPresentation: builder.query<PublicPresentationResponse, string>({
    ...
    generateSingleSlide: builder.mutation<
      PresentationResponse,
      { id: string; data: GenerateSingleSlideRequest }
    >({
      query: ({ id, data }) => ({
        url: `/api/presentations/${id}/slides/generate`,
        method: "POST",
        body: data,
      }),
      invalidatesTags: (_result, _error, { id }) => [
...
export const {
  ...
  useGenerateSingleSlideMutation,
