...
This project is indexed by GitNexus as **plan-frontend** (2174 symbols, 4392 relationships, 134 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
