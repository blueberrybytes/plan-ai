...
This project is indexed by GitNexus as **plan-backend** (2804 symbols, 8881 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
