...
This project is indexed by GitNexus as **plan-backend** (3312 symbols, 10534 relationships, 277 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
