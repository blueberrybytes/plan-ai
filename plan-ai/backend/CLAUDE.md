...
This project is indexed by GitNexus as **plan-backend** (2319 symbols, 7402 relationships, 192 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
