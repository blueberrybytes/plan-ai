...
import { getConfiguredModel, getStructuredProviderOptions } from "../utils/aiModelUtils";
...
export class ChatService {
  ...
  public async sendMessage(
    ...
    // 4.5 Persona Injection
    const personaInstructions = await getPersonaInstructions(userId, thread.workspaceId);
    const dynamicSystemPrompt = SYSTEM_PROMPT + contextSection + personaInstructions;
