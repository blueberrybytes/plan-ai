...
This project is indexed by GitNexus as **plan-backend** (2721 symbols, 8718 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
