...
This project is indexed by GitNexus as **plan-backend** (2332 symbols, 7423 relationships, 193 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
