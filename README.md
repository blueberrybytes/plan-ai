...
## 🌐 Try It Live!
You can try the fully functioning application here: **[plan-ai.blueberrybytes.com](https://plan-ai.blueberrybytes.com)**
...
| App                                                | Where to get it                                                                                               |
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| Desktop Recorder (macOS)                           | [Mac App Store — Plan AI Recorder](https://apps.apple.com/es/app/plan-ai-recorder/id6759553699?l=en-GB&mt=12) |
| Desktop Recorder (all platforms, direct downloads) | [GitHub Releases](https://github.com/blueberrybytes/plan-ai-recorder-releases/releases)                       |
| Mobile App (Android)                               | [Google Play — Plan AI](https://play.google.com/store/apps/details?id=com.blueberrybytes.planai)              |
| Mobile App (iOS)                                   | _Coming soon — App Store release in progress._                                                                |
...
| ------------------ | -------------------------------------------------- | ------------------------- |
| `plan-ai/frontend` | `yarn --cwd plan-ai/frontend generate:types:local` | Yes (localhost:8080)      |
| `plan-ai-recorder` | `yarn --cwd plan-ai-recorder generate:types`       | Yes (localhost:8080)      |
| `plan-ai-mobile`   | `yarn --cwd plan-ai-mobile generate:types`         | Yes (localhost:8080)      |
| All at once        | `yarn update`                                      | Yes (includes DB migrate) |

> **Note:** The backend must be running when generating types, since the script fetches `swagger.json` from the live server.
