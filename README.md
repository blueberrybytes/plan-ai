...
- **Plan Cortex (Codebase Intelligence):** We ship with a native Model Context Protocol (MCP) server that maps out the codebase graph, grounding every generated ticket in real symbols and file paths.
