...
| App                | Script                      | Notes                   |
| ------------------ | --------------------------- | ----------------------- |
| `plan-ai/frontend` | `yarn generate:types:local` | Backend must be running |
| `plan-ai-recorder` | `yarn generate:types`       | Backend must be running |
| `plan-ai-mobile`   | `yarn generate:types`       | Backend must be running |
...
This project is indexed by GitNexus as **plan** (7008 symbols, 11620 relationships, 206 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
