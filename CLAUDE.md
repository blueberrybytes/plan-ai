...
This project is indexed by GitNexus as **plan** (6720 symbols, 16666 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
