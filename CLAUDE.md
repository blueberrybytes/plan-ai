...
This project is indexed by GitNexus as **plan** (6640 symbols, 16095 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
