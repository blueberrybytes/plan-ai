    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [
            { dataType: "array", array: { dataType: "refObject", ref: "UserIntegrationSummary" } },
            { dataType: "enum", enums: [null] },
          ],
          required: true,
        },
...
export function RegisterRoutes(app: Router, opts?: { multer?: ReturnType<typeof multer> }) {
  ...
  app.get(
    ...
    async function HealthckeckController_getStatusPayload(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHealthckeckController_getStatusPayload,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ChatController_listThreads(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsChatController_listThreads,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ChatController_getThread(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsChatController_getThread,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ChatController_createThread(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsChatController_createThread,
          request,
          response,
        });
