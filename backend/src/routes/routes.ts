...
const models: TsoaRoute.Models = {
  ...
  SessionResponse: {
    ...
    properties: {
      ...
      metadata: {
        dataType: "union",
        subSchemas: [{ ref: "JsonValue" }, { dataType: "enum", enums: [null] }],
        required: true,
      },
  ...
  SessionListResponse: {
    ...
    properties: {
      sessions: {
        dataType: "array",
        array: { dataType: "refObject", ref: "SessionResponse" },
        required: true,
      },
  ...
  ApiResponse_SessionListResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "SessionListResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
  ...
  "_36_Enums.TranscriptSource": {
    ...
    type: {
      ...
      subSchemas: [
        ...
        { dataType: "enum", enums: ["RECORDING"] },
        { dataType: "enum", enums: ["UPLOAD"] },
        { dataType: "enum", enums: ["IMPORTED"] },
      ],
      validators: {},
    },
  },
  ...
  ApiResponse_TranscriptResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "TranscriptResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  TranscriptListResponse: {
    ...
    properties: {
      transcripts: {
        dataType: "array",
        array: { dataType: "refObject", ref: "TranscriptResponse" },
        required: true,
      },
      total: { dataType: "double", required: true },
    },
  ...
  ApiResponse_TranscriptListResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "TranscriptListResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  InputJsonObject: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {},
      additionalProperties: { ref: "InputJsonValue" },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  ManualTranscriptRequest: {
    ...
    properties: {
      ...
      metadata: {
        dataType: "union",
        subSchemas: [{ ref: "InputJsonValue" }, { dataType: "enum", enums: [null] }],
      },
    },
    additionalProperties: false,
  },
  ...
  TaskListResponse: {
    ...
    properties: {
      tasks: {
        dataType: "array",
        array: { dataType: "refObject", ref: "TaskResponse" },
        required: true,
      },
      total: { dataType: "double", required: true },
    },
  ...
  ApiResponse_TaskListResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "TaskListResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  ApiResponse_TaskResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "TaskResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  ApiResponse_SessionResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "SessionResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  TranscriptAnalysisResponse: {
    ...
    properties: {
      ...
      tasks: {
        dataType: "array",
        array: { dataType: "refObject", ref: "TranscriptTaskInsight" },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  ApiResponse_CreateTranscriptResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "CreateTranscriptResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  ApiResponse_UserResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "UserResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  ApiResponse_JiraAuthorizationResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "JiraAuthorizationResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  "_36_Enums.IntegrationProvider": {
    ...
    type: {
      dataType: "union",
      subSchemas: [
        { dataType: "enum", enums: ["JIRA"] },
        { dataType: "enum", enums: ["LINEAR"] },
      ],
      validators: {},
    },
  },
      ...
      nestedProperties: {
        ...
        data: {
          ...
          subSchemas: [
            {
              dataType: "array",
              array: { dataType: "refObject", ref: "UserIntegrationSummary" },
            },
            { dataType: "enum", enums: [null] },
          ],
          required: true,
      ...
      nestedProperties: {
        ...
        data: {
          ...
          subSchemas: [
            {
              dataType: "union",
              subSchemas: [{ ref: "UserIntegrationSummary" }, { dataType: "enum", enums: [null] }],
            },
            { dataType: "enum", enums: [null] },
          ],
          required: true,
  ...
  ContextResponse: {
    ...
    properties: {
      ...
      files: {
        dataType: "array",
        array: { dataType: "refObject", ref: "ContextFileResponse" },
        required: true,
      },
      createdAt: { dataType: "datetime", required: true },
      updatedAt: { dataType: "datetime", required: true },
  ...
  ContextListResponse: {
    ...
    properties: {
      contexts: {
        dataType: "array",
        array: { dataType: "refObject", ref: "ContextResponse" },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  ApiResponse_ContextListResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "ContextListResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  ApiResponse_ContextResponse_: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        data: {
          dataType: "union",
          subSchemas: [{ ref: "ContextResponse" }, { dataType: "enum", enums: [null] }],
          required: true,
        },
        status: { dataType: "double", required: true },
      },
  ...
  "DefaultSelection_Prisma._36_CustomThemePayload_": {
    ...
    type: {
      ...
      nestedProperties: {
        updatedAt: { dataType: "datetime", required: true },
        createdAt: { dataType: "datetime", required: true },
        configJson: { ref: "JsonValue", required: true },
        density: { dataType: "double", required: true },
        borderRadius: { dataType: "double", required: true },
        headingFontFamily: { dataType: "string", required: true },
        fontFamily: { dataType: "string", required: true },
        textSecondaryColor: { dataType: "string", required: true },
        textPrimaryColor: { dataType: "string", required: true },
        surfaceColor: { dataType: "string", required: true },
  ...
  CustomTheme: {
    dataType: "refAlias",
    type: {
      ref: "DefaultSelection_Prisma._36_CustomThemePayload_",
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
      ...
      nestedProperties: {
        ...
        data: {
          ...
          subSchemas: [
            {
              dataType: "union",
              subSchemas: [{ ref: "CustomTheme" }, { dataType: "enum", enums: [null] }],
            },
            { dataType: "enum", enums: [null] },
          ],
          required: true,
...
export function RegisterRoutes(app: Router, opts?: { multer?: ReturnType<typeof multer> }) {
  ...
  app.get(
    ...
    async function SessionsModelController_listSessions(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_listSessions,
          request,
          response,
        });
  ...
  const argsSessionsModelController_uploadTranscript: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    summary: { in: "formData", name: "summary", dataType: "string" },
  };
  app.post(
    ...
    async function SessionsModelController_uploadTranscript(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_uploadTranscript,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function SessionsModelController_listTranscripts(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_listTranscripts,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function SessionsModelController_getTranscript(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_getTranscript,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsSessionsModelController_createManualTranscript: Record<
    string,
  ...
  app.post(
    ...
    async function SessionsModelController_createManualTranscript(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_createManualTranscript,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function SessionsModelController_updateTranscript(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_updateTranscript,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function SessionsModelController_deleteTranscript(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_deleteTranscript,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function SessionsModelController_listTasks(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_listTasks,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function SessionsModelController_getTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_getTask,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function SessionsModelController_createTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_createTask,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function SessionsModelController_updateTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_updateTask,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function SessionsModelController_deleteTask(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_deleteTask,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function SessionsModelController_getSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_getSession,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function SessionsModelController_createSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_createSession,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function SessionsModelController_updateSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_updateSession,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function SessionsModelController_deleteSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_deleteSession,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function SessionsModelController_createTranscript(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionsModelController_createTranscript,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function SessionController_login(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionController_login,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function SessionController_getCurrentUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSessionController_getCurrentUser,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function JiraController_getAuthorizationUrl(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsJiraController_getAuthorizationUrl,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function JiraController_handleCallback(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsJiraController_handleCallback,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function IntegrationController_listIntegrations(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsIntegrationController_listIntegrations,
          request,
          response,
        });
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsHealthckeckController_getHealthStatus: Record<string, TsoaRoute.ParameterSchema> = {};
  app.get(
    "/api/healthcheck/status",
    ...fetchMiddlewares<RequestHandler>(HealthckeckController),
    ...fetchMiddlewares<RequestHandler>(HealthckeckController.prototype.getHealthStatus),

    async function HealthckeckController_getHealthStatus(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsHealthckeckController_getHealthStatus,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ContextController_listContexts(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_listContexts,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ContextController_createContext(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_createContext,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function ContextController_getContext(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_getContext,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function ContextController_updateContext(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_updateContext,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function ContextController_deleteContext(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_deleteContext,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function ContextController_uploadContextFile(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_uploadContextFile,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function ContextController_deleteContextFile(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsContextController_deleteContextFile,
          request,
          response,
        });
  ...
  app.get(
    ...
    async function AccountController_getCustomTheme(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAccountController_getCustomTheme,
          request,
          response,
        });
  ...
  app.put(
    ...
    async function AccountController_upsertCustomTheme(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAccountController_upsertCustomTheme,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function AccountController_deleteUser(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAccountController_deleteUser,
          request,
          response,
        });
  ...
  app.delete(
    ...
    async function AccountController_deleteMyAccount(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAccountController_deleteMyAccount,
          request,
          response,
        });
